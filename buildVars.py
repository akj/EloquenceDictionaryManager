...
addon_info = AddonInfo(
	...
	addon_name="eloquenceDictionaryManager",
	# Add-on summary/title, usually the user visible name of the add-on
	# Translators: Summary/title for this add-on
	# to be shown on installation and add-on information found in add-on store
	addon_summary=_("Eloquence Dictionary Manager"),
	# Add-on description
	addon_description=_(
	...
	addon_url="https://github.com/akj/EloquenceDictionaryManager",
	# URL for the add-on repository where the source code can be found
	addon_sourceURL="https://github.com/akj/EloquenceDictionaryManager",
	...
	addon_licenseURL="https://github.com/akj/EloquenceDictionaryManager/blob/main/COPYING.txt",
)
...
pythonSources: list[str] = ["addon/globalPlugins/eloquenceDictionaryManager/*.py"]
